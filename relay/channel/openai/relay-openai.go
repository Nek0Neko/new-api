...
func OaiStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	if !containStreamUsage {
		...
		// Some upstream proxies (e.g. Claude to OpenAI SSE bridges) put usage on
		// the final chunk with only completion_tokens populated. Mirror the
		// non-stream fallback so input is still billed.

...
export function SystemBrand(props: SystemBrandProps) {
  ...
  if (variant === 'inline') {
    return (
      ...
      >
        <div className='flex size-5 items-center justify-center overflow-hidden rounded-md dark:bg-white'>
          <img
            src={logo}
            alt={t('Logo')}
    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton
          ...
          render={<div />}
        >
          <div className='flex aspect-square size-8 items-center justify-center overflow-hidden rounded-lg dark:bg-white'>
            <img
              src={logo}
              alt={t('Logo')}

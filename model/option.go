...
func InitOptionMap() {
	...
	common.OptionMap["ImageGenerationLink"] = ""
	...
	common.OptionMap["UserApiEndpoints"] = ""
	...
	common.OptionMap["RechargeGroupMeta"] = setting.RechargeGroupMeta2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "UserApiEndpoints":
		system_setting.UserApiEndpoints = value
	case "WorkerUrl":
	...
	case "GroupGroupRatio":
		// Deprecated: tier×channel-group billing matrix has been removed.
		// Old persisted values are accepted as a no-op for clean upgrades.
		_ = value
	case "UserUsableGroups":
		err = setting.UpdateUserUsableGroupsByJSONString(value)
	case "RechargeGroupMeta":
		err = setting.UpdateRechargeGroupMetaByJSONString(value)
